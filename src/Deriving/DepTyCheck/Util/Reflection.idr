...
getConsRecs = do
  ...
  let finalConsRecs = mapWithKey' consRecs $ \tyName, (_, cons), givenTyArgs => do
    let wTyArgs = (maybe SortedMap.empty .| weightableTyArgs . args .| lookupType tyName) `intersectionMap` givenTyArgs
