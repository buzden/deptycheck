...
So far, the random values we've generated (name, age) have been independent of each other. But what if the **type** of one value needs to depend on the _value_ of another?
