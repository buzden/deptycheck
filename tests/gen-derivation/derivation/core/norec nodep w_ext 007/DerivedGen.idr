...
data X = MkX (Gen CanBeEmptyStatic Bool)

Show X where
  show _ = #"an "X""#

gensGen : Fuel -> (em : Emptiness) -> (a : Type) -> Gen CanBeEmptyStatic $ Gen em a
...
checkedGen : Fuel -> (Fuel -> (em : Emptiness) -> (a : Type) -> Gen CanBeEmptyStatic $ Gen em a) => Gen CanBeEmptyStatic X
