...
||| Gen0erator of non-recursive expressions (thus those that can be used with zero recursion bound).
...
--- Gen0eral methodology of writing autogenerated-like generators ---
